<template>
    <div class="root-container">
        ...
        <el-tabs v-model="activeName" @tab-click="handleTabClick">
            ...
            <el-tab-pane :label="i18nTexts.ui.settings.tabs.newtabcomponents" name="newtabcomponents">
                <el-row>
                    <el-col :span="5">
                        <div class="grid-content plugin-list">
                            <div class="plugin-searchbar">
                                <el-input placeholder="Search" icon="search" v-model="componentSearchText">
                                </el-input>
                            </div>
                            <div class="plugin-item website-item"
                    ...
                    <el-col :span="19">
                        <div class="grid-content bg-black plugin-editor">
                            <div v-if="currentComponent" class="plugin-editor-container">
                                ...
                                <div class="plugin-editor-config" style="overflow-y: auto;">
                                    <el-tabs style="height: 100%;" type="border-card" @tab-click="handleComponentTabClick">
                                        <el-tab-pane label="Simple Editor">
                                            <el-form style="padding: 12px; min-height: 150px;" ref="componentForm" :model="currentComponent" :rules="componentFormRuels" label-width="200px">
                                                <el-form-item :label="i18nTexts.ui.settings.fields.show">
                                                    <el-switch
                                                        v-model="currentComponent.show"
                                                        on-color="#20a0ff">
                                                    </el-switch>
                                                </el-form-item>
                                                <el-form-item>
                                                    <el-button type="primary" @click.native.prevent="handleComponentSubmit">{{i18nTexts.ui.settings.actions.save}}</el-button>
                                                </el-form-item>
                                            </el-form>
                                        </el-tab-pane>
                                        <el-tab-pane label="Advance Editor">
                                            <MonacoEditor class="editor" ref="componentEditor" v-if="componentTabIndex === 1" theme="vs-dark"
                                                v-model="currentComponentSource" @editorDidMount="onComponentEditorDidMount" language="json" />
                                            <div class="buttons" style="margin-top: 20px;">
                                                <el-button type="primary" @click.native.prevent="handleComponentCodeSubmit">{{i18nTexts.ui.settings.actions.save}}</el-button>
                                            </div>
                                        </el-tab-pane>
                                    </el-tabs>
                                </div>
...
import NewtabMixin from './mixins/newtab'
