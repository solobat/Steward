...
const settingUrls = ["chrome://settings/people", "chrome://settings/appearance", "chrome://settings/search", "chrome://settings/defaultBrowser", "chrome://settings/onStartup", "chrome://settings/privacy", "chrome://settings/passwordsAndForms", "chrome://settings/languages", "chrome://settings/downloads", "chrome://settings/printing", "chrome://settings/accessibility", "chrome://settings/system", "chrome://settings/reset", "chrome://settings/help"];
